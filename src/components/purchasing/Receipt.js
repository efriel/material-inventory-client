      ...
      <div>                        
              <Modal show={this.state.ModalDisplayStatus} onHide={this.modCloseHandler} dialogClassName="sm" aria-labelledby="contained-modal-title-vcenter" centered>
                ...
                <Modal.Header closeButton>
                  <Modal.Title>Set Receipt to {this.state.Purchaseid}</Modal.Title>                  
                </Modal.Header>

                <Modal.Body>                  
                  <div className="col-sm-12">
                  <div className="row">
                  <Form.Label className="col-sm-12">Select Receipt File</Form.Label>
                  <SelectDocs className="col-sm-12" value={this.state.Receiptid} name="DocNumber" onChange={this.handleChange.bind(this)} />                            
                  </div>  
                  </div>                                    
          ...
          <DataTable
            title="List of paid to be processed"
            columns={columns}
